...
func (c *userClient) GetUser(ctx context.Context, in *UserModel, opts ...grpc.CallOption) (*UserModel, error) {
	out := new(UserModel)
...
func (UnimplementedUserServer) GetUser(context.Context, *UserModel) (*UserModel, error) {
...
func _User_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUser(ctx, req.(*UserModel))
	}
